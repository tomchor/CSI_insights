#!/bin/bash -l
#PBS -A UMCP0012
#PBS -N S3d_Stabjet1_AMD
#PBS -k eod
#PBS -o logs/S3d_Stabjet1_AMD.out
#PBS -e logs/S3d_Stabjet1_AMD.err
...
peak_memusage.exe julia --project \
    surfjet_np.jl --fullname=S3d_Stabjet1_AMD --arch=GPU --factor=1 2>&1 | tee out/S3d_Stabjet1_AMD.out
