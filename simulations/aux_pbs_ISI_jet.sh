#!/bin/bash -l
#PBS -A UMCP0012
#PBS -N PNN_SIsurfjet6
#PBS -k eod
#PBS -o logs/PNN_SIsurfjet6.out
#PBS -e logs/PNN_SIsurfjet6.err
...
peak_memusage.exe julia --project \
    surfjet_np.jl --simname=PNN_SIsurfjet6 --factor=1 2>&1 | tee out/PNN_SIsurfjet6.out
