#!/bin/bash -l
#PBS -A UMCP0012
#PBS -N FNN_CIsurfjet3
#PBS -k eod
#PBS -o logs/FNN_CIsurfjet3.out
#PBS -e logs/FNN_CIsurfjet3.err
...
peak_memusage.exe julia --project \
    surfjet_np.jl --simname=FNN_CIsurfjet3 --factor=1 2>&1 | tee out/FNN_CIsurfjet3.out
